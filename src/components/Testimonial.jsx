...
const Testimonial = () => {
  return (
    ...
    viewport={{once: true}} 
      ...
      <h1 className='text-center text-2xl sm:text-4xl font-bold mb-2 text center mx-auto'>Customer <span className='underline underline-offset-4 decoration-1 under font-light'>Testimonials</span></h1>
      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {testimonialsData.map((testimonial, index) => (
          <div key={index} className='max-w-[340px] border shadow-lg rounded px-8 py-12 text-center'>
            ...
            <div className='flex justify-center gap-1 text-red-500 my-4'>
